    ...
    pub fn new() -> Self {
        ...
        Self {
            ...
            inputs: vec![
                ...
                Input {
                    name: "Desktop Audio 2".to_string(),
                    uuid: Uuid::new_v4().to_string(),
                    kind: "pulse_output_capture".to_string(),
                    muted: true,
                    volume_mul: 1.0,
                    ...
                    sync_offset: 0,
                    monitor_type: "OBS_MONITORING_TYPE_NONE".to_string(),
                    audio_tracks: [false, true, false, false, false, false],
                    settings: json!({}),
                },
                Input {
                    ...
                    balance: 0.5,
                    sync_offset: 0,
                    monitor_type: "OBS_MONITORING_TYPE_MONITOR_AND_OUTPUT".to_string(),
                    audio_tracks: [true, false, false, false, false, false],
                    settings: json!({}),
                },
                Input {
                    name: "Mic/Aux 2".to_string(),
                    uuid: Uuid::new_v4().to_string(),
                    kind: "pulse_input_capture".to_string(),
                    muted: true,
                    volume_mul: 1.0,
                ...
                Input {
                    ...
                    uuid: Uuid::new_v4().to_string(),
                    kind: "browser_source".to_string(),
                    muted: false,
                    volume_mul: 0.5,
                    volume_db: -6.02,
                    balance: 0.5,
                    sync_offset: 0,
                    monitor_type: "OBS_MONITORING_TYPE_MONITOR_ONLY".to_string(),
                    audio_tracks: [true, false, true, false, false, false],
                    settings: json!({ "url": "https://example.com/alerts" }),
                },
                Input {
                    name: "Media Source".to_string(),
                    uuid: Uuid::new_v4().to_string(),
                    kind: "ffmpeg_source".to_string(),
                    muted: false,
                    volume_mul: 0.7,
                    volume_db: -3.10,
                    balance: 0.5,
                    sync_offset: -50_000_000,
                    monitor_type: "OBS_MONITORING_TYPE_NONE".to_string(),
                    audio_tracks: [true, false, false, true, false, false],
                    settings: json!({ "local_file": "/media/background.mp3", "looping": true }),
                },
            ],
            streaming: false,
